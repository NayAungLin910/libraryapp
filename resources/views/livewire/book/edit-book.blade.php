<div class="flex place-content-center">
    <div class="mt-10 px-4 py-2 rounded-2xl bg-violet-500 text-white shadow-lg lg:w-2/5 w-full mx-2">
        ...
        <img class="rounded-xl shadow-lg max-w-[20rem] mx-auto" src="{{ asset('storage' . $book->image) }}"
        ...
        <form wire:submit='submit'>
            ...
            <!-- Submit button -->
            <div class="flex place-content-between mx-2">
                <a href="{{ route('admin.books.view') }}" class="button-white-rounded">
                    Back
                </a>
                ...
                <button type="button" class="button-green-rounded" wire:click='download' wire:target='download'
                    wire:loading.class="opacity-30 animate-pulse">
                    Download
                </button>
