        ...
        <div class="flex flex-wrap items-center place-content-center gap-2">
            ...
            <div class="rounded-xl bg-slate-50 hover:bg-violet-100 shadow-lg w-[20rem]">
                ...
                <div class="flex items-center p-2 place-content-between">
                    <a href="{{ route('admin.books.edit', ['id' => $book->id]) }}" class="button-green-rounded">Edit</a>
                    ...
                    <!-- Delete book -->
                    <button
                        onclick='openPopupSubmit("Are you sure about deleteing the book, {{ $book->name }}?", "", true, "book-delete", {{ $book->id }})'
                        class="button-violet-rounded">Delete</button>
                </div>
            </div>
            @endforeach
            @else
