        ...
        <nav class="flex gap-4 justify-around md:justify-normal items-center w-[92%] mx-auto p-1">
            ...
            <div
                ...
                <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 text-lg">
                    <li>
                        <a class="hover:text-slate-700 {{ request()->routeIs('auth.login') ? 'text-slate-700' : '' }}" href="{{ route('auth.login') }}">Login</a>
                    </li>
                    <li>
                        <a class="hover:text-slate-700 {{ request()->routeIs('auth.register') ? 'text-slate-700' : '' }}" href="{{ route('auth.register') }}">Register</a>
                    </li>
                </ul>
            </div>
